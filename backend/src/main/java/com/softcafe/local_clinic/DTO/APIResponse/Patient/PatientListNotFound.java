...
public record PatientListNotFound(
        ...
        String message,
        @Schema(name = "patients", description = "No patients", example = "null")
        List<com.softcafe.local_clinic.DTO.Patient.PatientDataDTO> patients,
        @Schema(name = "total pages", description = "The total number of pages to expect from the list", example = "0")
        int totalPages
